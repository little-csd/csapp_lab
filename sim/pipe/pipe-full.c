...
long long gen_instr_valid()
{
    return ((if_id_next->icode) == (I_NOP) || (if_id_next->icode) == 
      ...
      (if_id_next->icode) == (I_MRMOVQ) || (if_id_next->icode) == (I_IADDQ)
       || (if_id_next->icode) == (I_ALU) || (if_id_next->icode) == (I_JMP)
       || (if_id_next->icode) == (I_CALL) || (if_id_next->icode) == (I_RET)
       || (if_id_next->icode) == (I_PUSHQ) || (if_id_next->icode) == 
      (I_POPQ));
}
...
long long gen_need_regids()
{
    return ((if_id_next->icode) == (I_RRMOVQ) || (if_id_next->icode) == 
      (I_ALU) || (if_id_next->icode) == (I_PUSHQ) || (if_id_next->icode)
       == (I_POPQ) || (if_id_next->icode) == (I_IADDQ) || 
      (if_id_next->icode) == (I_IRMOVQ) || (if_id_next->icode) == 
...
{
    return ((((id_ex_curr->icode) == (I_IADDQ) || (id_ex_curr->icode) == 
          (I_ALU)) & !((mem_wb_next->status) == (STAT_ADR) || 
